    ...
    <section class="flex flex-col">
        ...
        <form class="custom-form">
            <div class="flex flex-col px-12 mb-8">
                ...
                <input v-model="type" class="custom-input" :class="validOrInvalidTypeClass" type="text"
                    placeholder="Titolo Inserito dal Cliente">
            </div>
            <div class="flex flex-col px-12">
                ...
                <textarea v-model="description" class="custom-input" :class="validOrInvalidDescriptionClass" rows="7"
                    type="text" placeholder="Descrizione inserita dal Cliente"></textarea>
            </div>
...
export default {
    ...
    methods: {
        ...
        postHTTP_booking: function () {
            ...
            axios.post("/api/client/booking/?format=json", data)
                .then(response => {
